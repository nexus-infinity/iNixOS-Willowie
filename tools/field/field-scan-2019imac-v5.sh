...
TIMESTAMP_SAFE=$(echo "${TIMESTAMP}" | tr -d '\n')
HOSTNAME_SAFE=$(hostname | tr -d '\n')
NIXOS_VERSION_SAFE=$(nixos-version 2>/dev/null | tr -d '\n' || echo 'unknown')
RAW_DIR_SAFE=$(echo "${RAW_DIR}" | tr -d '\n')
echo "DEBUG: SCAN_DIR='${SCAN_DIR}'"
echo "DEBUG: TIMESTAMP='${TIMESTAMP}'"
echo "DEBUG: TIMESTAMP_SAFE='${TIMESTAMP_SAFE}'"
echo "DEBUG: About to substitute in: '${SCAN_DIR}/report.md'"
ls -l "${SCAN_DIR}/report.md"
...
[nix-shell:/etc/nixos/tools/field]# ./field-scan-2019imac-v5.sh
=== FIELD Scanner v5 ===
Scan directory: /var/log/FIELD-Scan-20251027-142217
Timestamp: 20251027-142217
Collecting system information...
  Collecting: hostname
  Collecting: uname
  Collecting: nixos-version
  Collecting: nix-info
...
Collecting GPU information...
  Collecting: lspci-vga
  Collecting: lspci-full
  Collecting: drm-devices
Collecting storage information...
  Collecting: lsblk
  Collecting: lsblk-json
  Collecting: blkid
  Collecting: df
  Collecting: mount
  Collecting: btrfs-subvol-list
  Collecting: btrfs-fi-show
Collecting USB device information...
  Collecting: lsusb
  Collecting: usb-devices
Collecting PCI device information...
  Collecting: lspci-tree
Collecting network information...
  Collecting: ip-addr
  Collecting: ip-link
  Collecting: ip-route
  Collecting: nmcli-device
  Collecting: nmcli-connection
Collecting wireless information...
  Collecting: iw-dev
  Collecting: rfkill
Collecting Bluetooth information...
  Collecting: bluetoothctl
  Collecting: hciconfig
Collecting Thunderbolt information...
  Collecting: boltctl
Collecting audio information...
  Collecting: aplay-list
  Collecting: pactl-sinks
  Collecting: pactl-sources
Collecting camera/video information...
  Collecting: v4l2-devices
Collecting EFI/boot information...
  Collecting: efibootmgr
  Collecting: bootctl-status
  Collecting: ls-boot-efi
Collecting user information...
  Collecting: users
  Collecting: groups
  Collecting: current-user
Collecting NixOS configuration...
  Collecting: nixos-hardware-config
  Collecting: nixos-configuration
  Collecting: nixos-flake
  Collecting: nix-channels
Collecting service information...
  Collecting: systemctl-status
  Warning: systemctl-status collection failed
  Collecting: systemctl-failed
  Warning: systemctl-failed collection failed
Collecting kernel information...
  Collecting: lsmod
  Collecting: dmesg
Analyzing filesystems...
  Collecting: findmnt
  Collecting: findmnt-json

=== Generating Reports ===
Generating JSON report...
Generating Markdown report...
DEBUG: SCAN_DIR='/var/log/FIELD-Scan-20251027-142217'
DEBUG: TIMESTAMP='20251027-142217'
./field-scan-2019imac-v5.sh: line 336: TIMESTAMP_SAFE: unbound variable

[nix-shell:/etc/nixos/tools/field]# 
  fi
else
