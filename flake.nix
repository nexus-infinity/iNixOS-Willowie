{
  ...
  inputs = {
    ...
    # Aggregator flake (we already added dot-hive/flake.nix)
  ...
  Useful commands:
    ...
    - nix flake show .#            # inspect outputs for this flake
    - nixos-rebuild build --flake .#BearsiMac  # build without switching
