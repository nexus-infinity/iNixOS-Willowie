...
# Copy this ENTIRE file to /etc/nixos/configuration.nix on your NixOS machine
...

{
  ...
  networking.hostName = "nixos-kitchen";
  ...
  # This is NixOS 24.05 - adjust if different
  system.stateVersion = "24.05";
}

# TO APPLY THIS CONFIGURATION:
# 1. On NixOS: sudo nano /etc/nixos/configuration.nix
# 2. Copy this entire file content
# 3. Save and exit
# 4. sudo nixos-rebuild switch
# 5. After reboot, WiFi should appear in: nmcli device status
# 6. Connect: nmcli device wifi connect 'YOUR_SSID' password 'YOUR_PASSWORD'
